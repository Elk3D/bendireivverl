...
public class GentBatteryContent : ActionEventContent<GentBatteryContent.Properties>
{
	[Serializable]
	...
	private GentBattery m_GentBattery;

	protected override void OnInitialize()
	{
		m_GentBattery = (GentBattery)base.Connectable;
	}
