...
public class GentToolkitContent : ActionEventContent<GentToolkitContent.Properties>
{
	[Serializable]
	...
	private GentToolkit m_GentToolkit;

	protected override void OnInitialize()
	{
		m_GentToolkit = (GentToolkit)base.Connectable;
	}

	public void InitializeContent()
	{
		RemoveListeners();
		if (m_GentToolkit.Data != null && m_Properties != null && m_Properties.Length != 0)
		{
			Properties properties = m_Properties[0];
			properties.ActionEvent = CreateContent(m_GentToolkit.Data.Interactable);
